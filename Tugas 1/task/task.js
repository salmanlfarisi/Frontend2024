 ...
 */
const users = [
  { name: "Salman", age: 20, major: "Agama Islam" },
  { name: "Abu Bakar", age: 25, major: "Filsafat" },
  { name: "Ali", age: 22, major: "Ekonomi Syariah" },
  { name: "Umar", age: 24, major: "Biologi" },
  { name: "Utsman", age: 23, major: "Perdagangan" },
];
...
const main = () => {
   ...
   */
  console.log("# Get All Users After Modifications");
  all();
};
